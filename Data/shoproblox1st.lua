...
local page =
    ui.New(
    {
        Title = "Shop https://shoproblox1st.com"
    }
)
...
local TimeBetweenChatSlider =
    page.Slider(
    {
        Text = "Thời gian giữa 2 lần chat (phút)",
...
local ChatAdButton = page.Button(
    {
        ...
        Callback = function()
            local ad = {
                "shoproblox1st com shop roblox bán lẽ giá sỉ",
                "shoproblox1st com Shop roblox số lượng lớn",
                "shoproblox1st com AN TOÀN, UY TÍN, NHANH CHÓNG",
                "shoproblox1st com",
                "shoproblox1st com SHOP CHUYÊN BÁN ACC ROBLOX FRUIT GIÁ SỈ!",
                "shoproblox1st com"
            }
...
local welcomingEnabled = false
local welcomingButton =
    page.Toggle(
    {
        Text = "Bật tính năng chào mừng",
...
local blacklistButton =
    page.Button(
    {
        Text = "Để chặn người dùng sử dụng bot, hãy chặn họ trong roblox",
        Callback = function()
            -- do nothing
        end
    }
